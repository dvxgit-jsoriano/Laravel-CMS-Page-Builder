...
@switch($template->name)
    ...
    @case('Barista Cafe')
        ...
        <link
            ...
            rel="stylesheet">
        <link href="{{ asset('templates/barista-cafe/css/bootstrap.min.css') }}" rel="stylesheet">
        <link href="{{ asset('templates/barista-cafe/css/bootstrap-icons.css') }}" rel="stylesheet">
        <link href="{{ asset('templates/barista-cafe/css/vegas.min.css') }}" rel="stylesheet">
        <link href="{{ asset('templates/barista-cafe/css/tooplate-barista.css') }}" rel="stylesheet">
    @break
